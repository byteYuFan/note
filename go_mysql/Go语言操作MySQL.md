...
func main() {
	...
	dsn := "root:wyf20040305...@tcp(192.168.118.91:3306)/ginsql"
...
为什么defer db.Close()要写到后面呢？

很显然，如果发生错误，db就没有Close这个方法。
...
为了方便查询，我们事先定义哈一个结构体来存储user表的数据
...
![](D:\桌面\note\go_mysql\images\多行chaxun.png)
...
![](D:\桌面\note\go_mysql\images\insert.png)
...
<img src="D:\桌面\note\go_mysql\images\占位符.png" style="zoom: 80%;" />
